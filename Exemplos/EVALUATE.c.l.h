...
/* Program local variables for 'PGM-EVALUATE' */
...
static cob_u8_t	b_17[3] __attribute__((aligned));	/* WS-MESES */

/* End of local data storage */


/* Fields (local) */
static cob_field f_18	= {2, b_17, &a_2};	/* WS-MES */
static cob_field f_19	= {1, b_17 + 2, &a_3};	/* WS-STATUS */
