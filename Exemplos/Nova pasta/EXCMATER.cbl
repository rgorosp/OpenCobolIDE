      ...
      *      DISPLAY LK-AREA
            ...
            DELETE CFP001S2 RECORD
                  INVALID KEY
                       ...
                       DISPLAY ' '
                  NOT INVALID KEY
                       DISPLAY 'EXCLUSAO DE MATERIA EFETUADA!'
            END-DELETE
       ...
       P800-ERRO.
            DISPLAY '**********************************'
            DISPLAY '     ERRO PROGRAMA EXCMATER'
            DISPLAY '**********************************'
       ...
       P999-FIM.
            DISPLAY '--------------------------------------'
            DISPLAY '>>>> PROGRAMA EXCMATER FINALIZADO <<<<'
            DISPLAY '--------------------------------------'
            DISPLAY ' QTDE ALUNOS LIDOS.........: ' WS-R-MAT
            DISPLAY ' QTDE ALUNOS DELETADO......: ' WS-RW-MAT
            DISPLAY ' QTDE ALUNOS NAO ENCONTRADO: ' WS-R-MAT-INE
            DISPLAY '--------------------------------------'
            GOBACK.
       P999-EXIT.
            EXIT.
       END PROGRAM EXCMATER.
