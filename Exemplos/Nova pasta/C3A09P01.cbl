       ...
       PROGRAM-ID. C3A09P01.
      *---------------------------------------------------------------
      * PROGRAMA: CAPITULO 03 - AULA 09 - PRATICA 01
      *---------------------------------------------------------------
      * ========== |===| ===================================== | =====
      ...
      *-------------------------------------------------------------*
       ...
       FILE-CONTROL.
           SELECT ENTRADA  ASSIGN TO 'C:\Arquivos\E1-C3A09P01.txt'
                  ORGANIZATION IS LINE SEQUENTIAL
                  FILE STATUS IS WS-FS-E01
           .
           SELECT RELATOR  ASSIGN TO 'C:\Arquivos\S1-C3A09P01.txt'
      ...
      * --> 88 - UTILIZADO PARA VALORES FIXOS.
       ...
       77  WS-SPACES                 PIC X(080) VALUE SPACES.
      ...
      *--------------------------------------------------------------*
       ...
       051-IMPREL-INI.
           ...
           WRITE REG-RELATOR FROM WS-DET1 AFTER 2
           IF WS-FS-R01 NOT = '00'
      ...
      *--------------------------------------------------------------*
       052-IMPCAB SECTION.
       052-IMPCAB-INI.
           WRITE REG-RELATOR FROM WS-HIFEN AFTER ADVANCING PAGE
           IF WS-FS-R01 NOT = '00'
       ...
       052-IMPCAB-FIM.
           EXIT.
      *--------------------------------------------------------------*
      *  PROCEDIMENTO - TERMINO DO PROCESSAMENTO DO PROGRAMA C3A09P01
      *--------------------------------------------------------------*
       100-TERMINO SECTION.
       100-TERMINO-INI.
           PERFORM 010-DATA-HORA-DAY
           PERFORM 080-FECHAR
           DISPLAY '============= PGM.C3A09P01 ============'
           DISPLAY ' '.
      ...
      *----------------------------------------------------------------*
       ...
       998-VAZIO-INI.
           ...
           DISPLAY '     C3A09P01 SEM MOVIMENTO, FV. VERIFICAR.   '
           DISPLAY '=============================================='
      ...
      *--------------------------------------------------------------*
       ...
       999-ERRO-INI.
           DISPLAY '============================================'
           DISPLAY '        ERRO NO PROGRAMA C3A09P01           '
           DISPLAY '============================================'
