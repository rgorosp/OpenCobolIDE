       ...
       PROGRAM-ID. C4A02P01.
      *---------------------------------------------------------------
      * PROGRAMA: CAPITULO04 - AULA 02 - PRATICA 01
      *---------------------------------------------------------------
      *   LPAR     | V | DESCRICAO                             | DATA
      *   PRE7     |001| MONTAGEM DO PROGRAMA C4A02P01         | 09/10
      * ========== |===| ===================================== | =====
      *   DDNAME   |I/O|          DESCRICAO         |   COPY   | LRECL
      * ========== |===| ========================== | ======== | =====
      * - C4P01EN1 | I | ARQUIVO ENTRADA SEQUENCIAL |  - - - - |  040
      * - C4P01SA1 | O | ARQUIVO INDEXADO           |  - - - - |  040
      *---------------------------------------------------------------
      ...
      *-------------------------------------------------------------*
       ...
       FILE-CONTROL.
           SELECT C4P01EN1 ASSIGN TO
                  "C:/ARQUIVOS/E1-C4A02P01.txt"
                  ORGANIZATION IS LINE SEQUENTIAL
                  FILE STATUS IS WS-FS-EN1
           .
           SELECT C4P01SA1 ASSIGN TO
      ...
      *==> AREA DESTINADA A ENTRADA.
       01  WS-REG-C4P01EN1.
           ...
           05 SAL-HORA-EN1           PIC 9(03)V99.
           05 HRS-MES-EN1            PIC 9(03)V99.
           05 RESERVA-EN1            PIC X(05).
      *==> AREA DESTINADA A SAIDA.
       01  WS-REG-C4P01SA1.
           05 DEPTO-SA1              PIC 9(02).
           05 MATRICULA-SA1          PIC 9(03).
           05 NOME-SA1               PIC X(20).
           05 SAL-HORA-SA1           PIC 9(03)V99.
           05 HRS-MES-SA1            PIC 9(03)V99.
           05 RESERVA-SA1            PIC X(05).
      ...
      *--------------------------------------------------------------*
       ...
       015-ABRIR-INI.
           ...
           IF WS-FS-EN1 NOT EQUAL '00'
              MOVE 'ERRO AO ABRIR O ARQUIVO C4P01EN1'    TO WS-MSG-A
              MOVE WS-FS-EN1                             TO WS-MSG-B
           GO TO 999-ERRO
           END-IF

           OPEN OUTPUT C4P01SA1
           IF WS-FS-SA1 NOT EQUAL '00'
              MOVE 'ERRO AO ABRIR O ARQUIVO C4P01SA1'    TO WS-MSG-A
      ...
      *--------------------------------------------------------------*
       020-LEITURA SECTION.
       020-LEITURA-INI.
           READ C4P01EN1 INTO WS-REG-C4P01EN1

      D    EXHIBIT NAMED WS-REG-C4P01EN1

           IF WS-FS-EN1 NOT EQUAL '00' AND '10'
              MOVE 'ERRO NA LEITURA DO ARQUIVO C4P01EN1'  TO WS-MSG-A
              MOVE WS-FS-EN1                              TO WS-MSG-B
           GO TO 999-ERRO
           ELSE
      ...
      *--------------------------------------------------------------*
       ...
       050-PROCESSO-INI.
           MOVE WS-REG-C4P01EN1 TO WS-REG-C4P01SA1

      D    EXHIBIT NAMED WS-REG-C4P01EN1

           WRITE REG-C4P01SA1 FROM WS-REG-C4P01SA1
           IF WS-FS-SA1 NOT EQUAL '00'
              MOVE 'ERRO AO GRAVAR O ARQUIVO C4P01SA1'    TO WS-MSG-A
              MOVE WS-FS-SA1                              TO WS-MSG-B
           GO TO 999-ERRO
           END-IF
       ...
       050-PROCESSO-FIM.
           EXIT.
      *--------------------------------------------------------------*
      *  PROCEDIMENTO - TERMINO DO PROCESSAMENTO DO PROGRAMA C4A02P01
      *--------------------------------------------------------------*
       100-TERMINO SECTION.
       100-TERMINO-INI.
           PERFORM 010-DATA-HORA-DAY
           PERFORM 080-FECHAR
           DISPLAY '============= PGM.C4A02P01 ============'
           DISPLAY ' '.
           DISPLAY 'REG.LIDOS C4P01EN1 = ' WS-I-EN1
           DISPLAY 'REG.GRAV. C4P01SA1 = ' WS-O-SA1
           DISPLAY '======================================='
      ...
      *--------------------------------------------------------------*
       ...
       080-FECHAR-INI.
           CLOSE C4P01EN1
           IF WS-FS-EN1 NOT EQUAL '00'
              MOVE 'ERRO NO CLOSE DO ARQUIVO C4P01EN1'    TO WS-MSG-A
              MOVE WS-FS-EN1                              TO WS-MSG-B
           GO TO 999-ERRO
           END-IF
           ...
           CLOSE C4P01SA1
           IF WS-FS-SA1 NOT EQUAL '00'
              MOVE 'ERRO NO CLOSE DO ARQUIVO C4P01SA1'    TO WS-MSG-A
              MOVE WS-FS-SA1                              TO WS-MSG-B
           GO TO 999-ERRO
           END-IF
           .
      ...
      *----------------------------------------------------------------*
       ...
       998-VAZIO-INI.
           ...
           DISPLAY '     C4A02P01 SEM MOVIMENTO, FV. VERIFICAR.   '
           DISPLAY '=============================================='
           ...
           DISPLAY '=============================================='
           MOVE 1 TO RETURN-CODE WS-RETURN
           STOP RUN
           .
       998-VAZIO-FIM.
           EXIT.
      ...
      *--------------------------------------------------------------*
       ...
       999-ERRO-INI.
           DISPLAY '============================================'
           DISPLAY '        ERRO NO PROGRAMA C4A02P01           '
           DISPLAY '============================================'
