      ...
      * Date: 16/07/25
      * Purpose: COMANDO OCCURS ARRAY DINAMICO COM DEPENDING ON
      ******************************************************************
       ...
       01  WS-FINANCIAMENTO.
           ...
           03 WS-PARCELAS      PIC $$.$$9,99 OCCURS 1 TO 420
                               DEPENDING ON WS-CONTROLE.
       01  WS-VAR.
           03 WS-VLR-PARCELAS  PIC 9(07)V99 VALUE ZEROS.
           03 WS-INDICE        PIC 999 VALUE ZEROS.
           03 WS-CONTROLE      PIC 999 VALUE ZEROS.
       PROCEDURE DIVISION.
       S010 SECTION.
       P011-INICIO.
            ...
            ACCEPT WS-VALOR
            DISPLAY " "
            DISPLAY "Informe a quantidade de parcelas ate 420: "
            ACCEPT WS-CONTROLE
            DISPLAY " "
